...
public class Sound {
    ...
    private static final float BgVolMax = -15f;
    private static final float BgVolMin = -35f;
    private static float BgVol = -40f;
    //indicates the Max, Min and actual Volume of SFX
    private static final float SFXVolMax = -15f;
    private static final float SFXVolMin = -35f;
    private static float SFXVol = -20f;
    ...
    public static float getBgVolMax() {
        return BgVolMax;
    }

    public static float getBgVolMin() {
        return BgVolMin;
    }

    public static void setSFXVol(float value) {
        SFXVol = Math.min(value, SFXVolMax);
    }

    public static float getSFXVolMax() {
        return SFXVolMax;
    }

    public static float getSFXVolMin() {
        return SFXVolMin;
    }
}
